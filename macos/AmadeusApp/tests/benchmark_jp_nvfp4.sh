#!/bin/bash
# Benchmark Nemotron-Nano-9B-v2-Japanese (NVFP4) via vLLM on DGX Spark

ENDPOINT="http://192.168.1.44:8000"
MODEL="/workspace/model"
RESULTS_FILE="/Users/cheesiang_leow/research/amadeus_project/macos/AmadeusApp/tests/results/jp_nvfp4_results.jsonl"
SUMMARY_FILE="/Users/cheesiang_leow/research/amadeus_project/macos/AmadeusApp/tests/results/jp_nvfp4_summary.txt"
...
> "$RESULTS_FILE"
echo "=== Kurisu Benchmark: Nemotron-Nano-9B-v2-Japanese (NVFP4) ===" > "$SUMMARY_FILE"
