#!/bin/bash
# Benchmark Gemma 3 4B Kurisu (SFT+DPO, BF16) via vLLM

ENDPOINT="http://192.168.1.44:8000"
MODEL="/workspace/model"
RESULTS_FILE="/Users/cheesiang_leow/research/amadeus_project/macos/AmadeusApp/tests/results/gemma3_kurisu_results.jsonl"
SUMMARY_FILE="/Users/cheesiang_leow/research/amadeus_project/macos/AmadeusApp/tests/results/gemma3_kurisu_summary.txt"
...
> "$RESULTS_FILE"
echo "=== Kurisu Benchmark: Gemma 3 4B SFT+DPO BF16 ===" > "$SUMMARY_FILE"
